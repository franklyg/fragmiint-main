...
// Home Page
export async function homePageData(previewData) {
  const data = await fetchAPI(
    `
    query {
    	allHomes{
...
// About Page
export async function aboutPageData(previewData) {
  const data = await fetchAPI(
    `
    query {
    	allAbouts{
...
// Music Page
export async function musicPageData(previewData) {
  const data = await fetchAPI(
    `
    query {
    	allMusics{
